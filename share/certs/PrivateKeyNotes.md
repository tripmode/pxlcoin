...
unlocked to sign the Pxlcoin-Qt.app bundle.
...
allowing somebody to distribute a Pxlcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the pxlcoin-qt.exe file inside the installer had not been tampered with.
